...
class PRF_Final_CourseworkG{
	...
	public static String[] DelelteArrayElement(String[] br){
			...
			String PN=input.next();
					...
					if(isValid4nNumber(PN)==true&&PhoneNumberSearch(PN,PhoneNumber)==true){
							...
							double total = 0;
								...
								String[] Pnum=new String[PhoneNumber.length];
							...
							for(int i=0;i<PhoneNumber.length;i++){
								...
								SortQTY[i]=QTYarr[i];
								SortSize[i]=SizeArr[i];
								Pnum[i]=PhoneNumber[i];
							}
							
							//System.out.println(Arrays.toString(doubleAmount));
							//System.out.println(Arrays.toString(SortSize));
							//System.out.println(Arrays.toString(SortQTY));          
							...
							for(int i=0;i<PhoneNumber.length;i++){
										...
										int sum1=0;
											...
											if(PN.equals(Pnum[i])){
												...
												System.out.printf("\t\t|%-10s|%-10s|%15s|%n","  "+SortSize[i],"      "+sum1,"   "+df.format(doubleAmount[i])+"  ");
												total+=doubleAmount[i];
